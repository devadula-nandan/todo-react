...
import ResponsiveNavBar from "./layout/Nav";
...
const NotFound = () => {
  return (
    <div className="h-[calc(100vh-76px)] w-screen bg-teal-100 flex flex-col">
      ...
      <p className="text-teal-800 mx-auto mb-10 lg:text-4xl md:text-3xl sm:text-2xl text-xl text-center drop-shadow-2xl">Sorry, the page you are looking for does not exist.</p>

      <Link to="/" className="text-teal-800 m-auto rounded-3xl bg-teal-300 hover:bg-teal-400 hover:shadow-2xl transition-all px-4 py-2">
        {" "}
        Go Back Home
      </Link>
    </div>
